...
export const Header = () => {
	...
	return (
		<header className="header">
			<ModalUpdateProduct submitUpdateProduct={submitUpdateProduct} isOpen={visibleUpdateModal} onCancel={setVisibleUpdateModal}/>
			...
			<button className='btn btn-primary' onClick={setVisibleUpdateModal}>Add new</button>
		</header>
	)
}